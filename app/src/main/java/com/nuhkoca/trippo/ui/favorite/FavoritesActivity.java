...
public class FavoritesActivity extends DaggerAppCompatActivity implements ICatalogueItemClickListener.Favorite, IPopupMenuClickListener.Favorite {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFavoritesActivityViewModel = ViewModelProviders.of(this, viewModelFactory).get(FavoritesActivityViewModel.class);
    ...
    private void setupUI() {
        ...
        mFavoritesActivityViewModel.getFavoriteCountryList().observe(this, favoriteCountries -> {
            ...
            case R.id.delete_all_favorites_menu:
                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                    ...
                    new SnackbarUtils.Builder()
                            ...
                            .show(getString(R.string.sign_in_action_text), () -> startActivity(new Intent(FavoritesActivity.this, AuthActivity.class)));
                }
    ...
    private void getAll() {
        mFavoritesActivityViewModel.retrieveFavoriteCountryList().observe(this, favoriteCountries -> {
            mFavoriteCountryAdapter.submitList(favoriteCountries);
            mFavoriteCountries = favoriteCountries;
        });
    }
